...
void encryptAllImagesParallel(int n)
{
...
void decryptAllImagesParallel(int n)
{
...
void encryptAllImagesSerial(int n)
{
	//int n = fileCount("images");
...
void decryptAllImagesSerial(int n)
{
	//int n = fileCount("encryptedImages");
...
int main()
{
	...
	for(int i=100; i<=2300; i+=500)
	{
		clock_gettime(CLOCK_REALTIME, &start);
		
		encryptAllImagesSerial(i);
		decryptAllImagesSerial(i);
		...
		encryptAllImagesParallel(i);
		decryptAllImagesParallel(i);
		...
		printf("%d: %.2lf seconds\n", i, timeDurationSerial);
		printf("%d: %.2lf seconds\n\n", i, timeDurationParallel);
	}	
	return 0;
}
